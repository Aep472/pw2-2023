        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form class="form-horizontal bg-primary text-white my-5 mx-auto p-3 border rounded-4 shadow-sm w-md-50" method="POST" action="process_type.php">
                        <h1 class="text-center mb-3">Tambah Produk Tipe</h1>
